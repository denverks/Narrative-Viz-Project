function main() {
    ...
    d3.dsv(';', 'fifa21.csv').then(function (data) {
        ...
        // Filter data for overall ratings >= 90
    ...
    svg.append("text").attr("transform", "translate(100,0)")
        ...
        .attr('x', function(_, i) {
            return xScale(uniquePlayers[i]) + xScale.bandwidth() / 3;
        })
        .attr('y', function(d) {
        ...
        g.append("text")
            .attr("x", -320)
            .attr("y", -110)
            .text("Hover over any bar to display more information about each player.")
